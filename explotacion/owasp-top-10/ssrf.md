...
se acontece cuando un servidor web permite hacer consultas http del lado del servidor hacia un dominio arbitrario elegido por un atacante, lo cual permite hacer una conexión con servicios de la propia infraestructura interna donde se aloja la web y exfiltrar información sensible
...
esto nos permite que si podemos hacer un ssrf la cual esta en otra red, podriamos listar un recurso de una máquina a la cual no tendriamos acceso desde nuestra máquina de atacante:

!\[\[Pasted image 20251007194850.png]]
